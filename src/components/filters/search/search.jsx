...
import { showSearchFilter } from '../../../store/showFilter/action'
...
const Search = () => {
   ...
   /* useEffect(()=>{
    ...
    const onChangeInput = useCallback(
        debounce((value) => {
            if (value) {
                ...
                const filterTitle = Object.values(currentCards).filter((card) => {
          ...
          //  console.log(filterCards)  
            ...
            dispatch(showSearchFilter(true))
            }
        }, 1000),
        [],
    )
    ...
    const handleBlur = (e) => {
        setFocus(false)
        if (!value) {
            dispatch(showSearchFilter(false))
        }
    }
